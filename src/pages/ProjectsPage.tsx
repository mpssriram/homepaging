  ...
  return (
    <main className="site-page site-page--projects relative min-h-screen overflow-x-clip overflow-y-visible" id="top">
      <div className="relative z-[1]">
        ...
        <motion.section className="relative grid min-h-[34rem] p-[8.5rem_1.5rem_4.5rem] place-items-center overflow-hidden border-b border-[rgba(255,59,107,0.12)]" aria-labelledby="projects-page-title" ref={heroRef}>
          <motion.div className="absolute inset-[5rem_1rem_1rem] pointer-events-none border-x border-[rgba(34,211,238,0.14)] bg-[linear-gradient(90deg,rgba(34,211,238,0.09),transparent_7rem,transparent_calc(100%-7rem),rgba(34,211,238,0.09)),linear-gradient(rgba(255,255,255,0.035)_1px,transparent_1px)] bg-[auto,100%_4rem]" aria-hidden="true" style={{ y: gridY }} />
          <motion.div className="absolute inset-[6.5rem_max(1.5rem,calc((100%-74rem)/2))_2rem] pointer-events-none border border-[rgba(255,59,107,0.18)] shadow-[inset_0_0_2rem_rgba(34,211,238,0.04),0_0_3rem_rgba(34,211,238,0.04)] before:absolute before:top-[-1px] before:left-8 before:w-[6rem] before:h-[1px] before:bg-[#ff3b6b] before:shadow-[0_0_1rem_rgba(255,59,107,0.55)] after:absolute after:top-[-1px] after:right-8 after:w-[6rem] after:h-[1px] after:bg-[#ff3b6b] after:shadow-[0_0_1rem_rgba(255,59,107,0.55)]" aria-hidden="true" style={{ y: frameY }} />
        ...
        <section className="content-section pt-[4rem] pb-[8rem]">
          <Reveal className="visual-center-offset mx-auto flex max-w-[60rem] flex-col items-center border border-[rgba(255,59,107,0.16)] bg-[linear-gradient(155deg,rgba(10,25,45,0.72),rgba(8,18,32,0.82))] p-[clamp(1.4rem,4vw,3rem)] text-center min-w-0">
