  ...
  return (
    <main className="site-page site-page--events relative min-h-screen overflow-x-clip overflow-y-visible" id="top">
      <div className="relative z-[1]">
        ...
        <motion.section className="relative grid min-h-[34rem] p-[8.5rem_1.5rem_4.5rem] place-items-center overflow-hidden border-b border-[rgba(56,189,248,0.12)]" aria-labelledby="events-page-title" ref={heroRef}>
        ...
        <section className="content-section pt-[4rem] pb-[8rem]" id="join-events">
          <Reveal className="visual-center-offset mx-auto flex max-w-[60rem] flex-col items-center border border-[rgba(34,211,238,0.16)] bg-[linear-gradient(155deg,rgba(10,25,45,0.72),rgba(8,18,32,0.82))] p-[clamp(1.4rem,4vw,3rem)] text-center min-w-0">
